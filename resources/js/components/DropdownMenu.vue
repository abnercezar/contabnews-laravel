<template>
    <div class="relative inline-block w-full sm:w-auto">
        <button
            class="px-4 py-2 rounded font-bold transition bg-white text-[#00244a] border border-gray-200 shadow hover:bg-[#f5f5f5] focus:outline-none"
            @click="toggleMenu"
        >
            {{ label }}
            <svg
                ...
                <li
                    ...
                    :class="[
                        ...
                        selected === item
                            ...
                            : 'text-[#00244a] hover:bg-[#daa520] hover:text-white',
                    ]"
                >
                    {{ item }}
                </li>
